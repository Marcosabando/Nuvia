...
export function UploadZone({ onUploadComplete }: UploadZoneProps) {
  ...
  const uploadToServer = useCallback(async (uploadFile: UploadFile) => {
    try {
          ...
          <CardContent className="p-6">
            ...
            <div className="space-y-4">
              {uploadingFiles.map((uploadFile) => (
                <div key={uploadFile.id} className={`flex items-center gap-4 p-4 rounded-lg transition-all duration-300 ${
