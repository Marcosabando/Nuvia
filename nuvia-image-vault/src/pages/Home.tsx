          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              <Card className="bg-gradient-to-br from-white to-nuvia-peach/10 border border-nuvia-peach/30 shadow-nuvia-soft rounded-2xl hover:shadow-nuvia-glow transition-all">
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    <p className="text-sm text-nuvia-deep/70 font-medium">Imágenes Totales</p>
              ...
              <Card className="bg-gradient-to-br from-white to-nuvia-peach/10 border border-nuvia-peach/30 shadow-nuvia-soft rounded-2xl hover:shadow-nuvia-glow transition-all">
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    <p className="text-sm text-nuvia-deep/70 font-medium">Subidas Hoy</p>
              ...
              <Card className="bg-gradient-to-br from-white to-nuvia-peach/10 border border-nuvia-peach/30 shadow-nuvia-soft rounded-2xl hover:shadow-nuvia-glow transition-all">
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    <p className="text-sm text-nuvia-deep/70 font-medium">Almacenamiento</p>
          ...
          <Tabs value={activeTab} onValueChange={handleTabChange} className="space-y-6">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 w-full sm:w-auto">
                <TabsList className="grid w-full sm:w-fit grid-cols-3 bg-white/80 backdrop-blur-sm border border-nuvia-silver/30 rounded-xl">
                  <TabsTrigger
                    value="images"
                ...
                {(activeTab === "images" || activeTab === "videos") && (
                  <div className="flex border border-nuvia-silver/30 rounded-lg overflow-hidden bg-white/80 backdrop-blur-sm">
                    <Button
              ...
              {(activeTab === "images" || activeTab === "videos") && (
                <Badge variant="secondary" className="bg-white/80 text-nuvia-deep border-nuvia-silver/30 whitespace-nowrap">
                  {activeTab === "images" 
